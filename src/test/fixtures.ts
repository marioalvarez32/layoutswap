...
export function inventoryFixture(): Inventory {
  return {
    ...
    monitors: [
      monitor({ devicePath: 'path-msi-2', reportedName: 'MSI MP165 E6', connector: 'USB-C DisplayPort 2', state: 'Active', gdiName: String.raw`\\.\DISPLAY5`, position: { x: -1920, y: -1080 }, size: { width: 1920, height: 1080 }, refreshHz: 60, rotation: 0, scalePercent: 100 }),
      ...
      monitor({ devicePath: 'path-acer', reportedName: 'KG241Y X1', connector: 'HDMI', state: 'Active', gdiName: String.raw`\\.\DISPLAY2`, position: { x: 0, y: 0 }, size: { width: 1920, height: 1080 }, refreshHz: 60, rotation: 0, scalePercent: 100, primary: true }),
      monitor({ devicePath: 'path-builtin', reportedName: 'Built-in display', connector: 'Built-in', state: 'Active', gdiName: String.raw`\\.\DISPLAY1`, position: { x: 1920, y: 0 }, size: { width: 2560, height: 1600 }, refreshHz: 165, rotation: 0, scalePercent: 150 }),
