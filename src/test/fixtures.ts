...
export function inventoryFixture(): Inventory {
  return {
    ...
    monitors: [
      ...
      monitor({ devicePath: 'path-acer', reportedName: 'KG241Y X1', connector: 'HDMI', state: 'Active', gdiName: String.raw`\\.\DISPLAY2`, position: { x: 0, y: 0 }, size: { width: 1920, height: 1080 }, refreshHz: 60, rotation: 0, scalePercent: 100, primary: true, inputSource: 0x11, inputSourceName: 'HDMI 1', powerMode: 1, ddcCi: 'answered' }),
